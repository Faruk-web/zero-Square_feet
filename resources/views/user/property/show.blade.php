        ...
        <div class="col-xl-4 col-lg-5">
          <div class="wsus__property_sidebar" id="sticky_sidebar">
            ...
            {{--    @if ($property->user_type==1)
                ...
                <form action="/user/send/email" method="post">
                    ...
                    <div class="wsus__sidebar_input">
                        ...
                        <input type="hidden" name="poperty_id" value="{{$poperty_id}}">
                    </div>
                    <!--<div class="wsus__sidebar_input">-->
            ...
            <div class="row">
                ...
                <button  onclick="sendEmail('{{ $similar_item->id}}', '{{ $similar_item->title}}')" class="btn btn-success"> <i class="fas fa-envelope"></i> Email</button>
                                </div>
                            </div>
                            </div>
                        </div>
