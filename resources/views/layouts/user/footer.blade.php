...
@endif
  <!--=====FOOTER START=====-->
  <footer class="pt_45" style="border-top: 5px solid #bcd130;">
    <div class="container">
      <div class="row justify-content-between">
        <div class="col-xl-4 col-sm-8 col-md-7 col-lg-4">
          <div class="wsus__footer_content">
            <a href="{{ route('home') }}" class="footer_logo"><img src="{{ asset($setting->footer_logo) }}" style="background-color: white;padding: 10px;border-radius: 10px;" alt=""></a>
            <!-- <p class="footer_text">{{ $contactInfo->about }}</p> -->
            <p class="address"><i class="fal fa-location-circle" style="background:#bcd130 !important;"></i> {!! nl2br(e($footer_contact->footer_address)) !!}</p>
            <a class="call_mail" href="tel:{{ $footer_contact->footer_phone }}"><i class="fal fa-phone-alt" style="background-color:#bcd130 !important;"></i> {!! nl2br(e($footer_contact->footer_phone)) !!}</a>
            <a class="call_mail"href="mailto:{{ $footer_contact->footer_email }}"><i class="fal fa-envelope-open" style="background:#bcd130 !important;"></i> {!! nl2br(e($footer_contact->footer_email)) !!}</a>
          </div>
        </div>
  ...
  <!--=====SCROLL BUTTON START=====-->
    <div class="wsus__scroll_btn" style="background: #bcd130 !important">
...
<script type="text/javascript">
    ...
    function sendEmail(id,title) {
        $('.modal_poperty_id').val(id);
        $('#modal_poperty_title').text(title);
