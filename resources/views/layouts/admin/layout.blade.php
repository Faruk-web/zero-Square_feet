    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
               ...
               <img src="{{ url($app_setting->logo) }}" alt="logo"  style="width: 100px !important;background-color: white !important;padding: 10px !important;border-radius: 10px !important;">
            </a>
                ...
                Route::is('admin.property-purpose.*') || Route::is('admin.property-type.*') || Route::is('admin.nearest-location.*') || Route::is('admin.aminity.*') || Route::is('admin.package.*') || Route::is('admin.listing-review') || Route::is('admin.agents') ||  Route::is('admin.agents.show') || Route::is('admin.order') || Route::is('admin.order-show') || Route::is('admin.agent-property') || Route::is('admin.pending-order')
                 ? 'show':'' }}" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ Route::is('admin.property.create.*')?'active':'' }}" href="{{ route('admin.property.create') }}">Add Property</a>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseguides"
                    aria-expanded="true" aria-controls="collapseguides">
                    <i class="fas fa-columns"></i>
                    <span>{{ $websiteLang->where('lang_key','pages')->first()->custom_text }}</span>
                </a>
                <div id="collapseguides" class="collapse {{
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
                    ...
                    <i class="fas fa-columns"></i>
                    <span>{{ $websiteLang->where('lang_key','guides')->first()->custom_text }}</span>
                </a>
                <div id="collapsePages" class="collapse {{
                Route::is('admin.about.index') || Route::is('admin.terms-conditions.index') || Route::is('admin.custom-page.*') || Route::is('admin.faq.*') || Route::is('admin.privacy-policy')
                 ? 'show':'' }}" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item {{ Route::is('admin.main.area')?'active':'' }}" href="{{ route('admin.main.area') }}">{{ $websiteLang->where('lang_key','main_area')->first()->custom_text }}</a>
                        <a class="collapse-item {{ Route::is('admin.area.guides')?'active':'' }}" href="{{ route('admin.area.guides') }}">{{ $websiteLang->where('lang_key','area_guides')->first()->custom_text }}</a>

                        <a class="collapse-item {{ Route::is('admin.sale.buy.area')?'active':'' }}" href="{{ route('admin.sale.buy.area') }}">Sale/Buy Area Guides </a>
