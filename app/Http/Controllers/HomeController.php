...
class HomeController extends Controller
{
    ...
    public function addproperty(){
        ...
        $agent_bg=BannerImage::find(26);
        $websiteLang=ManageText::all();
        return view('user.add_property',compact('sliders', 'aboutUs','blogs','seo_text','sections','currency','overviews','services','default_profile_image','testimonials','properties','agents','orders','feature_image','propertyTypes','cities','websiteLang','testimonial_bg','agent_bg','service_bg'));
    }
    public function clientstore(Request $request){
        ...
        PropertyByClient::create($request->all());
