...
use App\Http\Controllers\AreaGuidesController;
...
Route::get('/add_property',[HomeController::class,'addproperty'])->name('add.property');
Route::post('/add_property/client/store',[HomeController::class,'clientstore'])->name('property.client.store');
...
Route::get('/area/guides',[GuidesController::class,'index'])->name('guides.index');
Route::get('/area/guides/gallery/{id}',[GuidesController::class,'gallery'])->name('guides.gallery');
...
Route::group(['as'=> 'user.', 'prefix' => 'user'],function (){
    ...
    Route::post('/send/email',[ContactController::class,'emailForUser']);
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    // custome Area Guides
    Route::get('main/area',[AreaGuidesController::class,'mainindex'])->name('main.area');
    Route::post('main/area/store',[AreaGuidesController::class,'mainindexstore'])->name('main.area.store');
    Route::post('guides/area/store',[AreaGuidesController::class,'guidesindexstore'])->name('guides.area.store');
    Route::post('guides/sales/buy/store',[AreaGuidesController::class,'guidessalesbuystore'])->name('guides.sales.buy.store');
    Route::get('area/guides',[AreaGuidesController::class,'index'])->name('area.guides');
    Route::get('sale/buy/area',[AreaGuidesController::class,'salebuyindex'])->name('sale.buy.area');
    Route::post('store-staff/',[AreaGuidesController::class,'store'])->name('store-staff');
